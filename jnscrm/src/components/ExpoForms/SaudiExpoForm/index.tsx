...
export default function SaudiExpoForm({
  formName = "Saudi Expo Form",
  onSubmitSuccess,
  className = "",
  labelColor = "text-black",
  eventDatesOptions = [
    'JnS Education Office - 18th January 2027 - Riyadh',
    'JnS Education Office - 19th January 2027 - Jeddah',
    'JnS Education Office - 20th January 2027 - Dammam'
  ]
}: {
  formName?: string;
    ...
    <div className={`bg-white rounded-xl shadow-md border border-gray-100 p-6 md:p-8 max-w-3xl mx-auto ${className}`}>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-start gap-3 pt-2">
          ...
          />
          <label htmlFor="saudiExpoConsent" className="text-sm font-medium text-black cursor-pointer">
