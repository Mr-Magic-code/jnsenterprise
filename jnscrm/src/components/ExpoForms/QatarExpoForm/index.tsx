...
export default function QatarExpoForm({
  formName = "Qatar Expo Form",
  onSubmitSuccess,
  className = "",
  labelColor = "text-black",
  eventDatesOptions = [
    'JnS Education Office - 18th January 2027 - Doha'
  ]
}: {
  formName?: string;
    ...
    <div className={`bg-white rounded-xl shadow-md border border-gray-100 p-6 md:p-8 max-w-3xl mx-auto ${className}`}>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-start gap-3 pt-2">
          ...
          />
          <label htmlFor="qatarExpoConsent" className="text-sm font-medium text-black cursor-pointer">
