...
export default function BahrainExpoForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Backend ke mutabiq Payload structure tayar kiya gaya hai
      const payload = {
        form_type: formName, // Yahan exact form name DB mein save hoga
      ...
      // NestJS Backend API Endpoint (CORS enabled hona chahiye backend par)
      ...
      // Successful submission ke baad Thank You page par redirect
